...
$query = $conn->prepare("SELECT username, user_images FROM registration_user WHERE email = ?");
$query->bind_param('s', $email); // 's' specifies the variable type => 'string'
...
// Get the user image URL from the session
            $userImageUrl = $_SESSION['user_images'];
