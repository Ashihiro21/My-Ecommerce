...
$sql = "SELECT ram.id, ram.capacity_gb, ram.type, ram.name, ram.quantity, ram.price, ram.i_id, ram.images, ram.speed_mhz, files.filename
        FROM ram
        INNER JOIN files ON ram.i_id = files.category_id";
            ...
            <div class='modal-dialog' role='document'>
                <div class='modal-content'>
                    ...
                    <div class='modal-body'>
                        Product added to cart successfully for user: " . $_SESSION['username'] . ".
                    </div>
                </div>
            </div>
        </div>
